...
- **[SEC EDGAR](https://github.com/stefanoamorelli/sec-edgar-mcp)** - (by stefanoamorelli) A community Model Context Protocol Server to access financial filings and data through the U.S. Securities and Exchange Commission ([SEC](https://www.sec.gov/)) Eletronic Data Gathering, Analysis, and Retrieval ([EDGAR](https://www.sec.gov/submit-filings/about-edgar)) database
