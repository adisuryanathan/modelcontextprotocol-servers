...
--**[Azure CosmosDB](https://github.com/AzureCosmosDB/azure-cosmos-mcp-server) - MCP server for Azure Cosmos DB, server that lets your LLMs (like Claude) talk directly to your Azure Cosmos DB data.
