...
- **[ChessPal Chess Engine](https://github.com/wilson-urdaneta/dylangames-mcp-chess-engine)** - A Stockfish-powered chess engine exposed as an MCP server. Calculates best moves and supports both HTTP and stdio transports. Part of the ChessPal project.
