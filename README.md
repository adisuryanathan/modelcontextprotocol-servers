...
- **[Google Search Console MCP (MCP-GSC)](https://github.com/AminForou/mcp-gsc)** - An MCP server for querying Google Search Console, retrieving search analytics, and managing indexing.
